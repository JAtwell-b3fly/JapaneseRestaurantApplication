...
const OrderCart = () => {
    ...
    const handleRemoveQuantity = (itemId, itemType) => {
     ...
     const handleRestaurantCartHeaderButton = () => {
        navigation.navigate("RestaurantCart", {userId});
    } 

    const handleAddMore = () => {
        navigation.navigate("Menu", {dishData, userId, selectedCondiments, selectedDrinks})
    }
    ...
    return(
        <View style={styles.main}>
            ...
            <View style={styles.top_btn_div}>
                <TouchableOpacity style={styles.delivery_btn}>
                    <Text style={styles.top_btn_text}>Order Delivery</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.restaurant_btn} onPress={() => handleRestaurantCartHeaderButton()}>
            ...
            <View style={styles.nav_box}>
                ...
                <TouchableOpacity style={styles.nav_btn} onPress={() => OrderCartSelected()}>
                    <Image source={require("../images/icons/shopping-cart-colour.png")} style={styles.nav_btn_image} />
                </TouchableOpacity>
